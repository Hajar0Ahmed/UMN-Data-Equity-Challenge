...
simplifieddat<-read.csv(file.choose())#
...
library(ggcorrplot)
library(dplyr)
colnames(simplifieddat)<-c("Sexuality","Gender","DrinkingLevel","Education Status:")
model.matrix(DrinkingLevel~Sexuality+Gender, data=simplifieddat) %>% 
  cor(use="pairwise.complete.obs") %>% 
  ggcorrplot(show.diag=FALSE, type="lower", lab=TRUE, lab_size=3,colors=c("red","yellow","green"))
